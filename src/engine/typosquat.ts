...
const TOP_PACKAGES: string[] = [
  // Core utilities
  'lodash', 'underscore', 'ramda', 'uuid', 'nanoid', 'semver',
  'chalk', 'colors', 'kleur', 'ansi-styles',
  'glob', 'minimatch', 'micromatch', 'rimraf', 'mkdirp', 'fs-extra',
  'path', 'debug', 'ms', 'bytes', 'mime', 'mime-types',
  'dotenv', 'cross-env', 'env-paths',
  'moment', 'dayjs', 'date-fns', 'luxon',
  'axios', 'got', 'node-fetch', 'undici', 'superagent', 'request',
  'commander', 'yargs', 'minimist', 'meow', 'inquirer', 'prompts',
  'ora', 'listr2', 'boxen', 'figures',
  'execa', 'cross-spawn', 'which', 'shebang-command',

  // Testing
  'jest', 'mocha', 'vitest', 'chai', 'sinon', 'nock', 'supertest',
  'jest-cli', 'ts-jest', '@testing-library/react',
  ...
  // Frameworks
  'express', 'koa', 'fastify', 'hapi', 'restify', 'feathers',
  'next', 'nuxt', 'gatsby', 'remix', 'astro', 'sveltekit',
  'react', 'react-dom', 'react-router', 'react-router-dom',
  'vue', '@vue/core', 'angular', '@angular/core',
  ...
  // Data fetching
  'react-query', '@tanstack/react-query', 'swr', 'apollo-client',
  'graphql', '@apollo/client',

  // Schema / Validation
  'zod', 'yup', 'joi', 'ajv', 'superstruct', 'class-validator',
  ...
  // Utility
  'immer', 'lodash-es', 'clsx', 'classnames', 'slugify',
  'sharp', 'jimp', 'multer', 'busboy', 'form-data',
  'socket.io', 'ws', 'node-ipc',
